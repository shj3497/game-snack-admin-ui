...
export type UserInfoResponseResultCode =
  (typeof UserInfoResponseResultCode)[keyof typeof UserInfoResponseResultCode];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UserInfoResponseResultCode = {
