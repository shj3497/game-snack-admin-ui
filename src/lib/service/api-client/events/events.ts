...
/**
 * 이벤트 이미지를 S3에 업로드합니다.
반환된 이미지 URL을 사용하여 이벤트를 생성할 수 있습니다.
 * @summary 이벤트 이미지 업로드
 */
...
export const getGetEventDetailSuspenseQueryOptions = <
  TData = Awaited<ReturnType<typeof getEventDetail>>,
  TError = unknown,
>(
  appId: string,
...
export type GetEventDetailSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getEventDetail>>
>;
export type GetEventDetailSuspenseQueryError = unknown;

export function useGetEventDetailSuspense<
  TData = Awaited<ReturnType<typeof getEventDetail>>,
  TError = unknown,
>(
  appId: string,
...
>(
  ...
  const queryOptions = getGetEventDetailSuspenseQueryOptions(
    appId,
    eventId,
    options,
  );
...
/**
 * 필터와 페이징 정보를 기반으로 이벤트 목록을 조회합니다.<br/><br/>- 필터 조건은 JSON 형식으로 전달됩니다.
 * @summary 이벤트 목록 조회
 */
...
export const getGetEventListSuspenseQueryOptions = <
  TData = Awaited<ReturnType<typeof getEventList>>,
  TError = unknown,
>(
  appId: string,
...
export type GetEventListSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getEventList>>
>;
export type GetEventListSuspenseQueryError = unknown;

export function useGetEventListSuspense<
  TData = Awaited<ReturnType<typeof getEventList>>,
  TError = unknown,
>(
  appId: string,
...
>(
  ...
  const queryOptions = getGetEventListSuspenseQueryOptions(
    appId,
    params,
    options,
  );
