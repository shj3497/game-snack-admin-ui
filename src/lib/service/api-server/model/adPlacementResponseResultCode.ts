...
export type AdPlacementResponseResultCode =
  (typeof AdPlacementResponseResultCode)[keyof typeof AdPlacementResponseResultCode];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AdPlacementResponseResultCode = {
