...
export type AppByUserResponseResultCode =
  (typeof AppByUserResponseResultCode)[keyof typeof AppByUserResponseResultCode];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AppByUserResponseResultCode = {
