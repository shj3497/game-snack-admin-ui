 ...
 * @summary 자신의 사용자 정보 조회
 */
export const prefetchAdminAuthGetMyInfo = async <
  TData = Awaited<ReturnType<typeof adminAuthGetMyInfo>>,
  TError = unknown,
>(
  queryClient: QueryClient,
 ...
 * @summary 앱 별 특정 사용자 상세정보 조회(workspace)
 */
export const prefetchAdminAuthGetUser = async <
  TData = Awaited<ReturnType<typeof adminAuthGetUser>>,
  TError = unknown,
>(
  queryClient: QueryClient,
 ...
 * @summary 앱 별 사용자 목록 조회(workspace)
 */
export const prefetchAdminAuthList = async <
  TData = Awaited<ReturnType<typeof adminAuthList>>,
  TError = unknown,
>(
  queryClient: QueryClient,
 ...
 * @summary 전체 사용자 목록 조회(superspace)
 */
export const prefetchAdminAuthListAllUsers = async <
  TData = Awaited<ReturnType<typeof adminAuthListAllUsers>>,
  TError = unknown,
>(
  queryClient: QueryClient,
