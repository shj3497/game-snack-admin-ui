 ...
 * @summary 리포트 매체 상세 조회
 */
export const prefetchGetReportProviderDetail = async <
  TData = Awaited<ReturnType<typeof getReportProviderDetail>>,
  TError = unknown,
>(
  queryClient: QueryClient,
 ...
 * @summary 리포트 매체 목록 조회
 */
export const prefetchGetReportProviderList = async <
  TData = Awaited<ReturnType<typeof getReportProviderList>>,
  TError = unknown,
>(
  queryClient: QueryClient,
 ...
 * @summary 리포트 통계 조회
 */
export const prefetchGetReportStats = async <
  TData = Awaited<ReturnType<typeof getReportStats>>,
  TError = unknown,
>(
  queryClient: QueryClient,
 ...
 * @summary 리포트 통계 엑셀 다운로드
 */
export const prefetchGetReportStatsExcel = async <
  TData = Awaited<ReturnType<typeof getReportStatsExcel>>,
  TError = unknown,
>(
  queryClient: QueryClient,
 ...
 * @summary 모든 이벤트 순응모 수 조회
 */
export const prefetchGetEventEntryStatsReport = async <
  TData = Awaited<ReturnType<typeof getEventEntryStatsReport>>,
  TError = unknown,
>(
  queryClient: QueryClient,
